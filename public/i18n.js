...
(() => {
    ...
    Object.assign(copy, {
        ...
        'Identité, sécurité et portefeuille': ['Identity, security and wallet', 'Umwirondoro, umutekano n’agasakoshi', 'Umwirondoro, umutekano n’ikofi', 'Utambulisho, usalama na pochi', 'Bomoto, bokengi mpe portefeuille'],
        'Créer, rejoindre et gérer vos AVEC': ['Create, join and manage your AVEC groups', 'Kurema, kwinjira no gucunga AVEC zawe', 'Kurema, kwinjira no gucunga imigwi ya AVEC yawe', 'Unda, jiunge na udhibiti AVEC zako', 'Kosala, kokota mpe kotambwisa AVEC na yo'],
        'Communauté sociale — contacts, fil, annonces et publicités': ['Social community — contacts, feed, announcements and advertisements', 'Umuryango rusange — abo muziranye, urutonde, amatangazo n’iyamamaza', 'Umuryango rusangi — abo muziranye, urutonde, amatangazo n’ukwamamaza', 'Jumuiya ya kijamii — mawasiliano, mlisho, matangazo na matangazo ya biashara', 'Lisanga ya bato — bato bayebani, nsango, mayebisi mpe bapiblisite'],
        'Accueil membre': ['Member home', 'Ahabanza h’umunyamuryango', 'Intango y’umunywanyi', 'Mwanzo wa mwanachama', 'Ebandeli ya mondimi'],
        'Votre photo de profil': ['Your profile photo', 'Ifoto y’umwirondoro wawe', 'Ifoto y’umwirondoro wawe', 'Picha yako ya wasifu', 'Elilingi ya profil na yo'],
        'Appuyez sur votre photo pour régler votre présence et votre visibilité.': ['Tap your photo to set your availability and visibility.', 'Kanda ifoto yawe kugira ngo uhindure uko uboneka n’ukugaragara kwawe.', 'Fyonda ifoto yawe kugira ngo uhindure ukuboneka n’ukubonwa kwawe.', 'Gusa picha yako kuweka hali yako na mwonekano wako.', 'Fina elilingi na yo mpo na kobongisa bozali mpe komonana na yo.'],
        'E-mail et photo de profil': ['Email and profile photo', 'Ime n’ifoto y’umwirondoro', 'Imeyili n’ifoto y’umwirondoro', 'Barua pepe na picha ya wasifu', 'Imeyili mpe elilingi ya profil'],
        'Ajoutez l’e-mail manquant d’un ancien compte et vérifiez-le avant les opérations sensibles. Votre photo reste protégée.': ['Add the missing email for a previous account and verify it before sensitive actions. Your photo remains protected.', 'Ongeraho ime ibura kuri konti ishaje kandi uyemeze mbere y’ibikorwa by’ingenzi. Ifoto yawe irakomeza kurindwa.', 'Shiramwo imeyili ibura kuri konti ya kera kandi uyemeze imbere y’ibikorwa bikomeye. Ifoto yawe iraguma ikingiwe.', 'Ongeza barua pepe inayokosekana ya akaunti ya zamani na uithibitishe kabla ya shughuli nyeti. Picha yako inalindwa.', 'Bakisa imeyili oyo ezangi na konti ya kala mpe ndima yango liboso ya misala ya bokengi. Elilingi na yo ebatelami.'],
        'Demander le code e-mail': ['Request email code', 'Saba kode ya ime', 'Saba kode ya imeyili', 'Omba msimbo wa barua pepe', 'Senga kode ya imeyili'],
        'Vérifier et enregistrer l’e-mail': ['Verify and save email', 'Emeza kandi ubike ime', 'Emeza kandi ubike imeyili', 'Thibitisha na uhifadhi barua pepe', 'Ndima mpe bomba imeyili'],
        'Photo de profil (JPEG, PNG ou WebP, 3 Mo maximum)': ['Profile photo (JPEG, PNG or WebP, maximum 3 MB)', 'Ifoto y’umwirondoro (JPEG, PNG cyangwa WebP, MB 3 ntarengwa)', 'Ifoto y’umwirondoro (JPEG, PNG canke WebP, MB 3 ntarengwa)', 'Picha ya wasifu (JPEG, PNG au WebP, upeo MB 3)', 'Elilingi ya profil (JPEG, PNG to WebP, koleka MB 3 te)'],
        'Enregistrer ma photo': ['Save my photo', 'Bika ifoto yanjye', 'Bika ifoto yanje', 'Hifadhi picha yangu', 'Bomba elilingi na ngai']
    });
